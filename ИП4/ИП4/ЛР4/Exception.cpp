...
WString  formatMessageW(unsigned long code, const  WString &moduleName=WString())
{
  ...
  LPTSTR errorMsg = nullptr; FormatMessage
...
//---------------------------------------------------------------------------
WsaException::WsaException(unsigned long errorCode)
  : code_(errorCode),
...
//---------------------------------------------------------------------------
String WsaException::message() const
{
  return message_;
}
//---------------------------------------------------------------------------
WString WsaException::message_w() const
{
  return formatMessageW(code_);
}
//---------------------------------------------------------------------------
unsigned long WsaException::code() const
{
  return code_;
}
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
WsaTimeOutException::WsaTimeOutException(unsigned long errorCode)
