...
//     iterator erase( const_iterator first, const_iterator last );
   ...
   private:
      ...
      static void shift_right(T* first, T* last, size_t count);
      static void shift_left(T* first, T* last, size_t count);
...
/* private static */
template<typename T>
void vector<T>::shift_right(T* first, T* last, size_t count)
{
  --last;
  T* middle = last-count;
...
/* private static */
template<typename T>
void vector<T>::shift_left(T* first, T* last, size_t count)
{
