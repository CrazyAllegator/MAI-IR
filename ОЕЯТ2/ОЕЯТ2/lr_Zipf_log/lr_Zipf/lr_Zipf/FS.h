...
class File
{
   public:
	  ...
	  unsigned long setFilePointer(long  distanceToMove, unsigned long moveMethod, long* distanceToMoveHigh = 0);
	  __int64 seek(__int64 distance, unsigned long moveMethod= FILE_CURRENT);
...
//---------------------------------------------------------------
void writeConsole(const WString& text); // Вывод utf16 в консоль
//---------------------------------------------------------------
#endif // FS_H
